...
public class MySwipeBackLayout extends FrameLayout {
    ...
    private MySwipeBackActivity mActivity;
    private View mContentView;
    private MySwipeBackFragment mFragment;
    ...
    private void init() {
        ...
        addSwipeListener(new OnSwipeListener() {
            @Override
            public void onDragStateChange(int state) {
                if (state == STATE_DRAGGING) {
                    setOnLayoutBack(false);
                } else if (state == STATE_IDLE) {
                    setOnLayoutBack(true);
                    reLayout();
                }
            }
    ...
    private boolean onLayout = true;

    private void setOnLayoutBack(boolean flag) {
        this.onLayout = flag;
    }
    ...
    public void setFragment(MySwipeBackFragment fragment, View view) {
    ...
    public void attachToActivity(MySwipeBackActivity activity) {
        mActivity = activity;
    ...
    public void attachToFragment(MySwipeBackFragment swipeBackFragment, View view) {
        addView(view);
    ...
    class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent > 1) {
                if (mFragment != null) {
                    if (mPreFragment instanceof MySwipeBackFragment) {
                        ((MySwipeBackFragment) mPreFragment).mLocking = true;
                    }
                    ...
                    if (mPreFragment instanceof MySwipeBackFragment) {
                        ((MySwipeBackFragment) mPreFragment).mLocking = false;
                    }
                } else {
        ...
        public int getViewHorizontalDragRange(View child) {
            if (mFragment != null) {
                return 1;
            } else if (mActivity != null && ((MySwipeBackActivity) mActivity).swipeBackPriority()) {
                return 1;
            }
